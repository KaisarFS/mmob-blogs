<template>
 <div :class="['min-h-screen', 'flex', 'flex-col', 'bg-gray-100', isDarkMode ? 'dark:bg-dark-bg' : '']">
    ...
    <!-- Mobile Menu -->
    <div class="fixed inset-0 z-50 flex bg-black bg-opacity-80 opacity-0 transition-opacity lg:hidden"
      ...
      <div class="ml-auto w-2/3 bg-green p-4 md:w-1/3">
        ...
        <ul class="mt-8 flex flex-col">
          <li v-for="item in navItems" :key="item.text">
            <NuxtLink :to="item.href" class="mb-3 block px-2 py-2 font-body text-lg font-medium text-white">
              {{ item.text }}
            </NuxtLink>
          </li>
        </ul>
    ...
    <main class="container mx-auto py-16 lg:py-20">
      <div>
        ...
        <form class="flex flex-col py-12 sm:flex-row">
          <input type="email" id="subscribe" placeholder="Drop your email here…"
