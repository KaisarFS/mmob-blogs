    ...
    <div class="container mx-auto">
      ...
      <div class="pt-12 pb-12 lg:pt-12 pb-12">
        ...
        <div class="flex items-center justify-center">
          <div class="mx-auto w-full max-w-[550px] bg-white dark:bg-[#1A202C]">
            <form class="py-4 px-9">
              <div class="mb-5">
                <label for="title" class="mb-3 block text-base font-medium text-[#07074D] dark:text-white">
                  Title
                </label>
              ...
              <div class="mb-5">
                ...
                <textarea type="text" name="title" id="title" placeholder="type title.."
                  class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
              </div>

              <div class="mb-6 pt-4">
                <label class="mb-5 block text-xl font-semibold text-[#07074D] dark:text-white">
                  Upload File
                </label>
                ...
                <div class="mb-8">
                  ...
                  <label for="file"
                    ...
                    <div>
                      <span class="mb-2 block text-xl font-semibold text-[#07074D] dark:text-white">
                        Drop files here
                      </span>
                      <span class="mb-2 block text-base font-medium text-[#6B7280] dark:text-white">
                        Or
                      </span>
                      <span
                        class="inline-flex rounded border border-[#e0e0e0] py-2 px-7 text-base font-medium text-[#07074D] dark:text-white">
                        Browse
                      </span>
                    </div>
                  </label>
